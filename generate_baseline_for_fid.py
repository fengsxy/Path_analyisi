#!/usr/bin/env python3
"""
Generate images for FID evaluation using Baseline model.

Usage:
    python generate_baseline_for_fid.py --checkpoint checkpoints/baseline_100ep.pth \
...
def parse_args():
    parser = argparse.ArgumentParser(description='Generate images for FID evaluation (Baseline)')
